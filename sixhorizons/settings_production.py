...
# ===----------------------------------------------------------------------===
# Django settings for sixhorizons project.
# ===----------------------------------------------------------------------===
...
DATABASES = {
  'default': {
    ...
    'NAME': os.path.abspath(os.path.join(PROJECT_DIRECTORY, '..', 'db', 'sqlite.db')),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.abspath(os.path.join(PROJECT_DIRECTORY, '..', 'pkg', 'var', 'www', 'www.sixhorizons.com', 'public', 'static'))
