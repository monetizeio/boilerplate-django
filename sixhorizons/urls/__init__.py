...
urlpatterns = patterns('',
  ...
  url(r'^login/',                   include('sixhorizons.urls.auth.login')),
  url(r'^logout/',                  include('sixhorizons.urls.auth.logout')),
  url(r'^account/password/change/', include('sixhorizons.urls.auth.password.change')),
  url(r'^account/password/reset/',  include('sixhorizons.urls.auth.password.reset')),
  url(r'^register/',                include('sixhorizons.urls.account.register')),
  url(r'^account/activate/',        include('sixhorizons.urls.account.activate')),
