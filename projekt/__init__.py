...
To get started, try exploring the following modules:
    ...
    `projekt.admin`       Django-admin interface
    `projekt.db`          Django model definitions
    `projekt.deploy`      WSGI deploy scripts
    `projekt.settings`    Development, testing, and production settings
    `projekt.urls`        Django URL specifications
