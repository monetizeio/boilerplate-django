...
urlpatterns = patterns('',
    ...
    url(r'^$',
        password_reset, {
            ...
            'template_name':       'auth/password_reset.html.j2',
    ...
    url(r'^done/$',
        password_reset_done, {
            ...
            'template_name': 'auth/password_reset_done.html.j2',
    ...
    url(r'^confirm/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
        password_reset_confirm, {
            ...
            'template_name':       'auth/password_reset_confirm.html.j2',
            # The token generator is an instance of an object which is capable of
    ...
    url(r'^complete/$',
        password_reset_complete, {
            ...
            'template_name': 'auth/password_reset_complete.html.j2',
