...
urlpatterns = patterns('',
    ...
    #       projekt.urls.account.activate module.
    url(r'^$',
        register, {
            ...
            # context.
            'template_name':  'account/registration.html.j2',
    ...
    url(r'^closed/$',
        direct_to_template, {
            ...
            # context variables.
            'template': 'account/registration_closed.html.j2'
    ...
    url(r'^complete/$',
        direct_to_template, {
            ...
            # context variables.
            'template': 'account/registration_complete.html.j2'
