...
for app in (
        # Django-extensions is a dependency of Django-patterns, and provides
        # the ever-useful shell_plus command for launching an ipython
        # interactive development shell.
        'django_extensions',

        # Our Django application, which provides setup and utilities for
        # assisting test discovery.
        'django_patterns',
